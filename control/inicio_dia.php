                ...
                <div>
                    <div class="bg-light p-4 rounded ">
                        <div class="col-sm-8 mx-auto">
                            <h1 class="text-center">Inicio día</h1>
                        </div>
                        <br>
                        <br>
                        ...
                        <div class="table-responsive" id="cierr0">
                            <table id="cierre0" class="display" style="width:100%" >
                                <thead>
                                    <tr>
                                        <th>Descripción</th>
                                        <th>Importe</th>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="clientes0" class="display w-70 mx-auto">
                                ...
                                $sqlclientes = mysqli_query($link,
                                    ...
                                    WHERE
                                        a.id_sucursal = $id_sucursal AND b.efectivo_hoy >= 100");
...
?>
                                    ...
                                    function extrae_tabla(consecutivo) {
                                        const columnasNecesarias = [0, 4, 7, 8]; // Equivalen a las columnas 1,4,5,9 (contando desde 1)
