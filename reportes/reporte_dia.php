...
WHERE a.id_sucursal = $id_sucursal AND a.id_venta = $id_venta AND a.id_consecutivo = $id_consecutivo;");
    while ($rowv = mysqli_fetch_assoc($sqlventas)) {
        if ($rowv['codigo_p'] == null) {
            if ($rowv['contador'] == 1) {
                if ($rowv['centralizar_almacen'] == 1 || get_equivalencia_producto_reporte_dia($link, $id_sucursal, $rowv['codigo']) !== null) {
            ...
            if ($rowv['centralizar_almacen_d'] == 1 || get_equivalencia_producto_reporte_dia($link, $id_sucursal, $rowv['codigo_d']) !== null) {
...
function get_equivalencia_producto_reporte_dia($link, $id_sucursal, $codigo) {
...
function resolver_inventario_producto_reporte_dia($link, $id_sucursal, $codigo, $cantidad) {
    $codigoInventario = (string) $codigo;
    $cantidadInventario = (float) $cantidad;
    $equivalencia = get_equivalencia_producto_reporte_dia($link, $id_sucursal, $codigoInventario);
...
function recalcula_almacen_producto($link, $id_sucursal, $codigo, $cantidad, $fecha_act, $hora_act, $id_usuario_act) {
    $inventario = resolver_inventario_producto_reporte_dia($link, $id_sucursal, $codigo, $cantidad);
